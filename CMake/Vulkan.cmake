...
elseif(LINUX)
    if(CMAKE_BUILD_TYPE MATCHES "Debug" OR CMAKE_BUILD_TYPE MATCHES "RelWithDebInfo")
        set_target_properties(slang PROPERTIES IMPORTED_LOCATION ${VULKAN_SDK_LIB_DIR}/libslang.so)
    else()
...
target_include_directories(volk INTERFACE ${VULKAN_SDK_INC_DIR})
if(WIN32)
    if(CMAKE_BUILD_TYPE MATCHES "Debug" OR CMAKE_BUILD_TYPE MATCHES "RelWithDebInfo")
        set_target_properties(volk PROPERTIES IMPORTED_LOCATION ${VULKAN_SDK_LIB_DIR}/volkd.lib)
        set_target_properties(volk PROPERTIES IMPORTED_PDB ${VULKAN_SDK_BIN_DIR}/volk.pdb)
    else()
        set_target_properties(volk PROPERTIES IMPORTED_LOCATION ${VULKAN_SDK_LIB_DIR}/volk.lib)
    endif ()
elseif(LINUX)
    if(CMAKE_BUILD_TYPE MATCHES "Debug" OR CMAKE_BUILD_TYPE MATCHES "RelWithDebInfo")
        set_target_properties(volk PROPERTIES IMPORTED_LOCATION ${VULKAN_SDK_LIB_DIR}/libvolk.a)
    else()
        set_target_properties(volk PROPERTIES IMPORTED_LOCATION ${VULKAN_SDK_LIB_DIR}/libvolk.a)
    endif ()
endif ()
