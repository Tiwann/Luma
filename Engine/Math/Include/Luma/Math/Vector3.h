...
namespace luma
{
    ...
    template<Number T> const TVector<T, 3> TVector<T, 3>::Zero      = { T(0), T(0), T(0) };
    template<Number T> const TVector<T, 3> TVector<T, 3>::One       = { T(1), T(1), T(1) };
    template<Number T> const TVector<T, 3> TVector<T, 3>::Right     = { T(1), T(0), T(0) };
    template<Number T> const TVector<T, 3> TVector<T, 3>::Up        = { T(0), T(1), T(0) };
    template<Number T> const TVector<T, 3> TVector<T, 3>::Left      = { T(-1), T(0), T(0) };
    template<Number T> const TVector<T, 3> TVector<T, 3>::Down      = { T(0), T(-1), T(0) };
    template<Number T> const TVector<T, 3> TVector<T, 3>::Forward   = { T(0), T(0), T(1) };
    template<Number T> const TVector<T, 3> TVector<T, 3>::Backward  = { T(0), T(0), T(-1) };
}
