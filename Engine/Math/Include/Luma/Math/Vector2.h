...
namespace luma
{
    ...
    template<Number T> const TVector<T, 2> TVector<T, 2>::Zero  = { T(0), T(0) };
    template<Number T> const TVector<T, 2> TVector<T, 2>::One   = { T(1), T(1) };
    template<Number T> const TVector<T, 2> TVector<T, 2>::Right = { T(1), T(0) };
    template<Number T> const TVector<T, 2> TVector<T, 2>::Up    = { T(0), T(1) };
    template<Number T> const TVector<T, 2> TVector<T, 2>::Left  = { T(-1), T(0) };
    template<Number T> const TVector<T, 2> TVector<T, 2>::Down  = { T(0), T(-1) };
}
