...
#include "Luma/Rendering/BlitRegion.h"
...
namespace Luma::OpenGL
{
    ...
    struct FClearColorCommand
    {
        FColor color = FColor::Black;
        uint32_t targetIndex = 0;
    };

    struct FClearDepthStencilCommand
    {
        float depth = 1.0f;
        uint32_t stencil = 0;
    };
    ...
    {
        const struct IRenderPipeline* pipeline = nullptr;
    };

    struct FBindComputePipelineCommand
    {
        const class IComputePipeline* pipeline = nullptr;
    };

    struct FBindVertexBuffersCommand
    {
        const struct IBuffer* buffer = nullptr;
        uint32_t binding = 0;
        uint64_t offset = 0;
    };
    ...
    {
        const Buffer* srcBuffer = nullptr;
        const TextureImpl* dstTexture = nullptr;
        size_t srcOffset = 0;
        size_t srcSize = 0;
    ...
    struct BlitCommand
    {
        const TextureImpl* srcTexture = nullptr;
        const TextureImpl* dstTexture = nullptr;
