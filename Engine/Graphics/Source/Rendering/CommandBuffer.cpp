...
namespace luma
{
    void IRenderCommandBuffer::draw(const uint32_t vertexCount, const uint32_t instanceCount,
    ...
    void IRenderCommandBuffer::drawIndexed(const uint32_t indexCount, const uint32_t instanceCount, const uint32_t firstIndex,
